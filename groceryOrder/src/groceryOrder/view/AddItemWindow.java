...
import groceryOrder.controller.AddItemAction;
...
public class AddItemWindow extends JFrame {
	...
	public AddItemWindow(CommandPanel frame) throws HeadlessException {
		super();
		this.panel = frame;
		build();
	}
	...
	private JPanel buildContentPane() {
		...
		JLabel title = new JLabel("<html><p style='font-size: 20px; color: #008ba3'>Add Item</p></html>");
		...
		JButton submit = new JButton(new AddItemAction("Submit", name_t, controler, this));
