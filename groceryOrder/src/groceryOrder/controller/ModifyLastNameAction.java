...
public class ModifyLastNameAction extends AbstractAction {
	...
	public ModifyLastNameAction(String arg0, User user, JTextField input, JFrame frame, Home panel) {
		super(arg0);
		this.frame = frame;
	...
	public void actionPerformed(ActionEvent arg0) {
		dao.modifyLastname(input.getText(), user);
